...
def main():
    ...
    robot_cfg_path = "/catkin_ws/src/IDC_CuRobo_Project/robot"
    ...
    motion_gen_config = MotionGenConfig.load_from_robot_config(
        "/catkin_ws/src/IDC_CuRobo_Project/robot/IRB6620_Config.yaml",
        world_cfg,
        tensor_args,
    ...
    while simulation_app.is_running():
        ...
        # sim_js => .get_joint_states() output:
#         classJointsState(positions: numpy.ndarray, velocities: numpy.ndarray, efforts: numpy.ndarray)
#           [summary]
#           Parameters
...
#       .dof_names => gives the list of JointNames !
#       prim.dof_names   (Franka Robot)
...
#       'panda_joint6', 'panda_joint7', 'panda_finger_joint1', 'panda_finger_joint2']
        ...
        # Sphere Visualization of the robot in Omniverse
        ...
        robot_static = False
        # Changing the values of velocities from 0.2 to 0.02 to make sure if the robot is stopped completely (of the previous movement)
        if (np.max(np.abs(sim_js.velocities)) < 0.02) or args.reactive:
            robot_static = True
        
        if (robot_static):
            
            # Subscribing Topic (np Tuple of Position + Orientation):
            # Position : np.array 3
