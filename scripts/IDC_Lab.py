...
class CuRoboRobot(object):
    def __init__(self,
        ...
        self._tensor_args = TensorDeviceType(device=torch.device("cuda", Cuda_Device))
        self._robot_cfg_path = w_dir
...
#             test._my_world.step(render=True) 
        ...
        robots[0].plan(tcp_name="tool1",
                       target_pose=[3.51, -0.27, 1.24],
                       update_world_needed= True)
        robots[0].render_exec(Show_Sphere= False)
