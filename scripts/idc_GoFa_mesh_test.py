...
class WorldManager(object):
    def __init__(self):
        ...
        # Making the Roof Invisible
        # self._stage.GetPrimAtPath("/World/obstacles/Roof").GetAttribute("visibility").Set("invisible")
