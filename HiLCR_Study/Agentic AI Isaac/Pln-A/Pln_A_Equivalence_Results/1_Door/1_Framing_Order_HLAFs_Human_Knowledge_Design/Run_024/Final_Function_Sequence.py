...
convloc_Wooden_Element_13 = Place_Short_Horizontal_Element_On_Smart_Conveyor_by_Rob1_Gripper(el_name='Wooden_Element_13', X=0.3514, Y=2.02, L=0.96, H=0.254)
Nail_Short_Horizontal_Element_by_Rob1_NailGun(el_pose=[0.3514, 2.02, 0.0254], el_dims=[0.96, 0.0508, 0.254], conv_current_location=convloc_Wooden_Element_13)
...
convloc_Wooden_Element_14 = Place_Short_Horizontal_Element_On_Smart_Conveyor_by_Rob1_Gripper(el_name='Wooden_Element_14', X=0.3514, Y=2.02, L=0.96, H=0.254)
Nail_Short_Horizontal_Element_by_Rob1_NailGun(el_pose=[0.3514, 2.02, 0.0762], el_dims=[0.96, 0.0508, 0.254], conv_current_location=convloc_Wooden_Element_14)
...
# Final complementary nailing for bottom connections
