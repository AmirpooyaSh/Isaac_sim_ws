...
side_L_U_Element_1 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.2592, Y=0.0908, L=2.4384, H=0.1016)
Nail_and_Release_Vertical_Element(el_name='L_U_Element_1', X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_L_U_Element_1, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name='R_Stud_4', X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_R_Stud_4, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name='R_Stud_6', X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_R_Stud_6, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name='R_Stud_8', X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_R_Stud_8, Is_Held=False)
# Install left King Stud
Pick_8ft_Element_From_Sloped_Table(el_name='Wooden_Element_6', L=2.4384, W=0.04, H=0.1016)
side_Wooden_Element_6 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.2592, Y=1.52, L=2.4384, H=0.1016)
Nail_and_Release_Vertical_Element(el_name='Wooden_Element_6', X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_Wooden_Element_6, Is_Held=False)
# Install right King Stud
Pick_8ft_Element_From_Sloped_Table(el_name='Wooden_Element_7', L=2.4384, W=0.04, H=0.1016)
side_Wooden_Element_7 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.2592, Y=2.52, L=2.4384, H=0.1016)
Nail_and_Release_Vertical_Element(el_name='Wooden_Element_7', X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_Wooden_Element_7, Is_Held=False)
# Install left Jack Stud
Pick_Short_Element_From_Mat_Supply(el_name='Wooden_Element_12', L=2.0, W=0.04, H=0.1016)
side_Wooden_Element_12 = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name='Wooden_Element_12', X=1.4784, Y=1.56, L=2.0, H=0.1016, If_Tangent_From_Left=True)
Nail_Vertical_Element_With_Tangent_to_an_Element(push_to_nail=0.01, el_pose=[1.4784, 1.56, 0.0], el_dims=[2.0, 0.04, 0.1016], If_Tangent_From_Left=True, Side_Selector=side_Wooden_Element_12)
# Install right Jack Stud
Pick_Short_Element_From_Mat_Supply(el_name='Wooden_Element_11', L=2.0, W=0.04, H=0.1016)
side_Wooden_Element_11 = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name='Wooden_Element_11', X=1.4784, Y=2.48, L=2.0, H=0.1016, If_Tangent_From_Left=False)
Nail_Vertical_Element_With_Tangent_to_an_Element(push_to_nail=0.01, el_pose=[1.4784, 2.48, 0.0], el_dims=[2.0, 0.04, 0.1016], If_Tangent_From_Left=False, Side_Selector=side_Wooden_Element_11)
# Install Bear Loading Header plank 1
Pick_Short_Element_From_Mat_Supply(el_name='Wooden_Element_13', L=0.96, W=0.0508, H=0.254)
conv_loc_hdr1 = Place_Short_Horizontal_Element_On_Smart_Conveyor_by_Rob2_Gripper(el_name='Wooden_Element_13', X=0.3514, Y=2.02, L=0.96, H=0.254)
Nail_Short_Horizontal_Element_by_Rob2_NailGun(push_to_nail=0.01, el_pose=[0.3514, 2.02, 0.0254], el_dims=[0.96, 0.0508, 0.254], conv_current_location=conv_loc_hdr1)
# Install Bear Loading Header plank 2
Pick_Short_Element_From_Mat_Supply(el_name='Wooden_Element_14', L=0.96, W=0.0508, H=0.254)
conv_loc_hdr2 = Place_Short_Horizontal_Element_On_Smart_Conveyor_by_Rob2_Gripper(el_name='Wooden_Element_14', X=0.3514, Y=2.02, L=0.96, H=0.254)
Nail_Short_Horizontal_Element_by_Rob2_NailGun(push_to_nail=0.01, el_pose=[0.3514, 2.02, 0.0762], el_dims=[0.96, 0.0508, 0.254], conv_current_location=conv_loc_hdr2)
...
Nail_and_Release_Vertical_Element(el_name='R_Stud_18', X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_R_Stud_18, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name='R_Stud_20', X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_R_Stud_20, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name='R_Stud_22', X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_R_Stud_22, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name='R_Stud_24', X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_R_Stud_24, Is_Held=False)
...
# Complementary nailing operation to secure bottom plate and remaining joints
