...
Nail_and_Release_Vertical_Element(el_name="F_Stud", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_sel_F_Stud, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name="R_Stud_2", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_sel_R_Stud_2, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name="R_Stud_4", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_sel_R_Stud_4, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name="R_Stud_6", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_sel_R_Stud_6, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name="R_Stud_8", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_sel_R_Stud_8, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name="Wooden_Element_6", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_sel_King_L, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name="Wooden_Element_7", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_sel_King_R, Is_Held=False)
...
Nail_Vertical_Element_With_Tangent_to_an_Element(push_to_nail=0.01, el_pose=[1.4784, 1.56, 0.0], el_dims=[2.0, 0.04, 0.1016], If_Tangent_From_Left=True, Side_Selector=side_sel_Jack_L)
...
Nail_Vertical_Element_With_Tangent_to_an_Element(push_to_nail=0.01, el_pose=[1.4784, 2.48, 0.0], el_dims=[2.0, 0.04, 0.1016], If_Tangent_From_Left=False, Side_Selector=side_sel_Jack_R)
# Install Bear Loading Header 1 (Wooden_Element_13)
...
# Install Bear Loading Header 2 (Wooden_Element_14)
...
Nail_and_Release_Vertical_Element(el_name="R_Stud_18", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_sel_R_Stud_18, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name="R_Stud_20", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_sel_R_Stud_20, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name="R_Stud_22", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_sel_R_Stud_22, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name="R_Stud_24", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_sel_R_Stud_24, Is_Held=False)
...
conv_bottom_plate = Place_Short_Horizontal_Element_On_Smart_Conveyor_by_Rob1_Gripper(el_name="Bot_Stud", X=2.4984, Y=1.8288, L=3.6576, H=0.1016)
Nail_Short_Horizontal_Element_by_Rob1_NailGun(push_to_nail=0.01, el_pose=[2.4984, 1.8288, 0.06], el_dims=[3.6576, 0.04, 0.1016], conv_current_location=conv_bottom_plate)
