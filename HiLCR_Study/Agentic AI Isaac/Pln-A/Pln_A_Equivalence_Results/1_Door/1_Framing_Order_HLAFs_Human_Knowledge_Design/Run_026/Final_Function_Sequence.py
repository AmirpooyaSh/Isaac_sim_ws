...
# Install King Stud (left) Wooden_Element_6
Pick_8ft_Element_From_Sloped_Table(el_name='Wooden_Element_6', L=2.4384, W=0.04, H=0.1016)
side_sel_KS_left = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.2592, Y=1.52, L=2.4384, H=0.1016)
Nail_and_Release_Vertical_Element(el_name='Wooden_Element_6', X=1.2592, L=2.4384, H=0.1016, Side_Selector=side_sel_KS_left, Is_Held=False)
# Install King Stud (right) Wooden_Element_7
Pick_8ft_Element_From_Sloped_Table(el_name='Wooden_Element_7', L=2.4384, W=0.04, H=0.1016)
side_sel_KS_right = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.2592, Y=2.52, L=2.4384, H=0.1016)
Nail_and_Release_Vertical_Element(el_name='Wooden_Element_7', X=1.2592, L=2.4384, H=0.1016, Side_Selector=side_sel_KS_right, Is_Held=False)
# Install Jack Stud (left) Wooden_Element_12
Pick_Short_Element_From_Mat_Supply(el_name='Wooden_Element_12', L=2.0, W=0.04, H=0.1016)
side_sel_Jack_left = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name='Wooden_Element_12', X=1.4784, Y=1.56, L=2.0, H=0.1016, If_Tangent_From_Left=True)
Nail_Vertical_Element_With_Tangent_to_an_Element(el_pose=[1.4784, 1.56, 0.0], el_dims=[2.0, 0.04, 0.1016], If_Tangent_From_Left=True, Side_Selector=side_sel_Jack_left)
# Install Jack Stud (right) Wooden_Element_11
Pick_Short_Element_From_Mat_Supply(el_name='Wooden_Element_11', L=2.0, W=0.04, H=0.1016)
side_sel_Jack_right = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name='Wooden_Element_11', X=1.4784, Y=2.48, L=2.0, H=0.1016, If_Tangent_From_Left=False)
Nail_Vertical_Element_With_Tangent_to_an_Element(el_pose=[1.4784, 2.48, 0.0], el_dims=[2.0, 0.04, 0.1016], If_Tangent_From_Left=False, Side_Selector=side_sel_Jack_right)
# Install Bear Loading Header plank 1 (Wooden_Element_13)
Pick_2x10_Header(X=0.3514, L=0.96)
Cut_2x10_Header(L=0.96, W=0.0508, H=0.254)
conv_loc_header1 = Place_2x10_Header(X=0.3514, Y=2.02, Z=0.0254, L=0.96, W=0.0508, H=0.254)
Nail_2x10_Header(el_pose=[0.3514, 2.02, 0.0254], el_dims=[0.96, 0.0508, 0.254], conv_current_location=conv_loc_header1)
# Install Bear Loading Header plank 2 (Wooden_Element_14)
Pick_2x10_Header(X=0.3514, L=0.96)
Cut_2x10_Header(L=0.96, W=0.0508, H=0.254)
conv_loc_header2 = Place_2x10_Header(X=0.3514, Y=2.02, Z=0.0762, L=0.96, W=0.0508, H=0.254)
Nail_2x10_Header(el_pose=[0.3514, 2.02, 0.0762], el_dims=[0.96, 0.0508, 0.254], conv_current_location=conv_loc_header2)
