...
side_King_Left = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.2592, Y=1.52, H=0.1016)
...
side_King_Right = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.2592, Y=2.52, H=0.1016)
...
side_Jack_Left = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name="Wooden_Element_12", X=1.4784, Y=1.56, L=2.0, H=0.1016, If_Tangent_From_Left=True)
...
side_Jack_Right = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name="Wooden_Element_11", X=1.4784, Y=2.48, L=2.0, H=0.1016, If_Tangent_From_Left=False)
...
Nail_Short_Horizontal_Element_by_Rob2_NailGun(el_pose=[2.4984, 1.8288, 0.06], el_dims=[3.6576, 0.04, 0.1016], conv_current_location=1.8288)
