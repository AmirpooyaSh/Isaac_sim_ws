...
# Install Top Plate (Top_Stud): Pick, Pass, Place
...
# Standard Vertical Stud F_Stud: Pick, Place & Nail
...
# Optional L/U Stud L_U_Element_1: Pick, Pass, Place
...
# Door Opening: King Stud Left (Wooden_Element_6)
Pick_8ft_Element_From_Sloped_Table(el_name='Wooden_Element_6', L=2.4384, W=0.04, H=0.1016)
side_selector_King_left = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.2592, Y=1.52, L=2.4384, H=0.1016)
Nail_and_Release_Vertical_Element(el_name='Wooden_Element_6', X=1.2592, L=2.4384, H=0.1016, Side_Selector=side_selector_King_left, Is_Held=False)
# Door Opening: King Stud Right (Wooden_Element_7)
Pick_8ft_Element_From_Sloped_Table(el_name='Wooden_Element_7', L=2.4384, W=0.04, H=0.1016)
side_selector_King_right = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.2592, Y=2.52, L=2.4384, H=0.1016)
Nail_and_Release_Vertical_Element(el_name='Wooden_Element_7', X=1.2592, L=2.4384, H=0.1016, Side_Selector=side_selector_King_right, Is_Held=False)
# Door Opening: Jack Stud Left (Wooden_Element_12)
Pick_Short_Element_From_Mat_Supply(el_name='Wooden_Element_12', L=2.0, W=0.04, H=0.1016)
side_selector_Jack_left = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name='Wooden_Element_12', X=1.4784, Y=1.56, L=2.0, H=0.1016, If_Tangent_From_Left=True)
Nail_Vertical_Element_With_Tangent_to_an_Element(el_pose=[1.4784, 1.56, 0.0], el_dims=[2.0, 0.04, 0.1016], If_Tangent_From_Left=True, Side_Selector=side_selector_Jack_left)
# Door Opening: Jack Stud Right (Wooden_Element_11)
Pick_Short_Element_From_Mat_Supply(el_name='Wooden_Element_11', L=2.0, W=0.04, H=0.1016)
side_selector_Jack_right = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name='Wooden_Element_11', X=1.4784, Y=2.48, L=2.0, H=0.1016, If_Tangent_From_Left=False)
Nail_Vertical_Element_With_Tangent_to_an_Element(el_pose=[1.4784, 2.48, 0.0], el_dims=[2.0, 0.04, 0.1016], If_Tangent_From_Left=False, Side_Selector=side_selector_Jack_right)
# Door Header: Bear Loading Plank 1 (Wooden_Element_13)
...
conv_loc_BL1 = Place_Short_Horizontal_Element_On_Smart_Conveyor_by_Rob1_Gripper(el_name='Wooden_Element_13', X=0.3514, Y=2.02, L=0.96, H=0.254)
Nail_Short_Horizontal_Element_by_Rob1_NailGun(el_pose=[0.3514, 2.02, 0.0254], el_dims=[0.96, 0.0508, 0.254], conv_current_location=conv_loc_BL1)
# Door Header: Bear Loading Plank 2 (Wooden_Element_14)
...
conv_loc_BL2 = Place_Short_Horizontal_Element_On_Smart_Conveyor_by_Rob1_Gripper(el_name='Wooden_Element_14', X=0.3514, Y=2.02, L=0.96, H=0.254)
Nail_Short_Horizontal_Element_by_Rob1_NailGun(el_pose=[0.3514, 2.02, 0.0762], el_dims=[0.96, 0.0508, 0.254], conv_current_location=conv_loc_BL2)
# Post-opening Vertical Stud R_Stud_18
...
# Post-opening Vertical Stud R_Stud_20
...
# Post-opening Vertical Stud R_Stud_22
...
# Post-opening Vertical Stud R_Stud_24
...
# Install Bottom Plate (Bot_Stud): Pick, Place, Nail
