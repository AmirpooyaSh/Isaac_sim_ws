...
# Right side studs up to Y=1.2392
...
# King studs and remaining verticals
...
BL_1_Placement_CurConv = Place_2x10_Header(X=0.3514, Y=2.02, Z=0.0254, L=0.96, W=0.0508, H=0.254)
Nail_2x10_Header(push_to_nail=0.05, el_pose=[0.3514, 2.02, 0.0254], el_dims=[0.96, 0.0508, 0.254], conv_current_location=BL_1_Placement_CurConv)
Pick_2x10_Header(X=0.3514, L=0.96)
Cut_2x10_Header(L=0.96, W=0.0508, H=0.254)
BL_2_Placement_CurConv = Place_2x10_Header(X=0.3514, Y=2.02, Z=0.0762, L=0.96, W=0.0508, H=0.254)
Nail_2x10_Header(push_to_nail=0.05, el_pose=[0.3514, 2.02, 0.0762], el_dims=[0.96, 0.0508, 0.254], conv_current_location=BL_2_Placement_CurConv)
# Bottom Plate and complementary nailing
