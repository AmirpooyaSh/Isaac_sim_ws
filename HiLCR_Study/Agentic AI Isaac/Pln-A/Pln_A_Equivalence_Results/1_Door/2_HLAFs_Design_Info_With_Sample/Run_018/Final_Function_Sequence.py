...
# Place and nail L_U_Element_1
Pick_8ft_Element_From_Sloped_Table(el_name="L_U_Element_1", L=2.4384, W=0.04, H=0.1016)
L_U_Element_1_SS = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.2592, Y=0.0908, L=2.4384, H=0.1016)
Nail_and_Release_Vertical_Element(el_name="L_U_Element_1", X=1.2592, L=2.4384, H=0.1016, Side_Selector=L_U_Element_1_SS)
# Place and nail R_Stud_2
...
# Place and nail Wooden_Element_6
...
# Place and nail Wooden_Element_7
...
# Place and nail Wooden_Element_12 (Jack Stud)
...
# Place and nail Wooden_Element_11 (Jack Stud)
...
# First header placement and nailing
Pick_2x10_Header(X=0.3514, L=0.96)
Cut_2x10_Header(L=0.96, W=0.0508, H=0.254)
Wooden_Element_13_conv = Place_2x10_Header(X=0.3514, Y=2.02, Z=0.0254, L=0.96, W=0.0508, H=0.254)
Nail_2x10_Header(push_to_nail=0.05, el_pose=[0.3514, 2.02, 0.0254], el_dims=[0.96, 0.0508, 0.254], conv_current_location=Wooden_Element_13_conv)
# Second header placement and nailing
Pick_2x10_Header(X=0.3514, L=0.96)
Cut_2x10_Header(L=0.96, W=0.0508, H=0.254)
Wooden_Element_14_conv = Place_2x10_Header(X=0.3514, Y=2.02, Z=0.0762, L=0.96, W=0.0508, H=0.254)
Nail_2x10_Header(push_to_nail=0.05, el_pose=[0.3514, 2.02, 0.0762], el_dims=[0.96, 0.0508, 0.254], conv_current_location=Wooden_Element_14_conv)
