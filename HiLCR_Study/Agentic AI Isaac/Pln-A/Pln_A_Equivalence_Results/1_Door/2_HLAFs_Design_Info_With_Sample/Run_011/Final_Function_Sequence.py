...
# Place and nail the first vertical stud (F_Stud)
...
# Place the corner L/U stud with suction (no nailing required)
...
# Place and nail King Stud Wooden_Element_6
...
# Place and nail King Stud Wooden_Element_7
...
# Pick, place and nail Jack Stud Wooden_Element_12 (tangent from left)
...
Nail_Vertical_Element_With_Tangent_to_an_Element(el_pose=[1.4784, 1.56, 0], el_dims=[2.0, 0.04, 0.1016], If_Tangent_From_Left=True, Side_Selector=Wooden_Element_12_SS)
# Pick, place and nail Jack Stud Wooden_Element_11 (tangent from right)
...
Nail_Vertical_Element_With_Tangent_to_an_Element(el_pose=[1.4784, 2.48, 0], el_dims=[2.0, 0.04, 0.1016], If_Tangent_From_Left=False, Side_Selector=Wooden_Element_11_SS)
...
# Pick, cut, place and nail first Bear Loading element
...
Nail_2x10_Header(el_pose=[0.3514, 2.02, 0.0254], el_dims=[0.96, 0.0508, 0.254], conv_current_location=Wooden_Element_13_Conv)
# Pick, cut, place and nail second Bear Loading element
Pick_2x10_Header(X=0.3514, L=0.96)
Cut_2x10_Header(L=0.96, W=0.0508, H=0.254)
Wooden_Element_14_Conv = Place_2x10_Header(X=0.3514, Y=2.02, Z=0.0762, L=0.96, W=0.0508, H=0.254)
Nail_2x10_Header(el_pose=[0.3514, 2.02, 0.0762], el_dims=[0.96, 0.0508, 0.254], conv_current_location=Wooden_Element_14_Conv)
...
# Complementary nailing for all vertical elements
