...
# First king stud at the frameline (F_Stud)
...
# L/U stud placed by suction hand-off
...
# Sequential 8-ft vertical studs along the wall
...
# Left jack stud tangent placement
...
# Right jack stud tangent placement
...
# Remaining sequence of 8-ft studs towards the end of the wall
...
# Two 2×10 headers over the door opening
...
Nail_2x10_Header(el_pose=[0.3514, 2.02, 0.0254], el_dims=[0.96, 0.0508, 0.254], conv_current_location=BL_13_Conv)
Pick_2x10_Header(X=0.3514, L=0.96)
Cut_2x10_Header(L=0.96, W=0.0508, H=0.254)
BL_14_Conv = Place_2x10_Header(X=0.3514, Y=2.02, Z=0.0762, L=0.96, W=0.0508, H=0.254)
Nail_2x10_Header(el_pose=[0.3514, 2.02, 0.0762], el_dims=[0.96, 0.0508, 0.254], conv_current_location=BL_14_Conv)
