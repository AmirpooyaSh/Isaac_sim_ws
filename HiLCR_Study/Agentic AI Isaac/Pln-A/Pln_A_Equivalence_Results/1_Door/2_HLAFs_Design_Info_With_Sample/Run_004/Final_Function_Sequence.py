...
# First full-length vertical stud at Y=0.02
...
# L/U stud installed by suction hand-off
...
# Left jack stud (Wooden_Element_12) tangent from left
Pick_Short_Element_From_Mat_Supply(el_name='Wooden_Element_12', L=2.0, W=0.04, H=0.1016)
WE12_SS = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name='Wooden_Element_12', X=1.4784, Y=1.56, L=2.0, H=0.1016, If_Tangent_From_Left=True)
Nail_Vertical_Element_With_Tangent_to_an_Element(el_pose=[1.4784, 1.56, 0.0], el_dims=[2.0, 0.04, 0.1016], If_Tangent_From_Left=True, Side_Selector=WE12_SS)
# Right jack stud (Wooden_Element_11) tangent from right
Pick_Short_Element_From_Mat_Supply(el_name='Wooden_Element_11', L=2.0, W=0.04, H=0.1016)
WE11_SS = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name='Wooden_Element_11', X=1.4784, Y=2.48, L=2.0, H=0.1016, If_Tangent_From_Left=False)
Nail_Vertical_Element_With_Tangent_to_an_Element(el_pose=[1.4784, 2.48, 0.0], el_dims=[2.0, 0.04, 0.1016], If_Tangent_From_Left=False, Side_Selector=WE11_SS)
# King stud at Y=1.52
...
# Bear Loading element at Z=0.0254
...
# Bear Loading element at Z=0.0762
Pick_2x10_Header(X=0.3514, L=0.96)
Cut_2x10_Header(L=0.96, W=0.0508, H=0.254)
