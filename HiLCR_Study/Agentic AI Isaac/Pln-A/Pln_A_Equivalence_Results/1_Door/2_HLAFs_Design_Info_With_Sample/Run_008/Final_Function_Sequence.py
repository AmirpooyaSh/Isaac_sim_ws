...
# Top plate: pick, hand-off, and place
...
# Front stud (F_Stud): pick, place, nail & release
...
# L/U Element: pick, pass to suction, and place
...
# R_Stud_2: pick, place, nail & release
...
# R_Stud_4: pick, place, nail & release
...
# R_Stud_6: pick, place, nail & release
...
# R_Stud_8: pick, place, nail & release
...
# Wooden_Element_6 (King Stud): pick, place, nail & release
...
# Wooden_Element_7 (King Stud): pick, place, nail & release
...
# Wooden_Element_12 (Jack Stud): pick, drop tangent left, nail
...
# Wooden_Element_11 (Jack Stud): pick, drop tangent right, nail
...
# Bear Loading Element 13: pick, cut, place, nail
Pick_2x10_Header(X=0.3514, L=0.96)
Cut_2x10_Header(L=0.96, W=0.0508, H=0.254)
BL_13_CurConv = Place_2x10_Header(X=0.3514, Y=2.02, Z=0.0254, L=0.96, W=0.0508, H=0.254)
Nail_2x10_Header(push_to_nail=0.125, el_pose=[0.3514, 2.02, 0.0254], el_dims=[0.96, 0.0508, 0.254], conv_current_location=BL_13_CurConv)
# Bear Loading Element 14: pick, cut, place, nail
Pick_2x10_Header(X=0.3514, L=0.96)
Cut_2x10_Header(L=0.96, W=0.0508, H=0.254)
BL_14_CurConv = Place_2x10_Header(X=0.3514, Y=2.02, Z=0.0762, L=0.96, W=0.0508, H=0.254)
Nail_2x10_Header(push_to_nail=0.125, el_pose=[0.3514, 2.02, 0.0762], el_dims=[0.96, 0.0508, 0.254], conv_current_location=BL_14_CurConv)
# Additional vertical studs R_Stud_18: pick, place, nail & release
...
# R_Stud_20: pick, place, nail & release
...
# R_Stud_22: pick, place, nail & release
...
# R_Stud_24: pick, place, nail & release
...
# Bottom plate: pick and place by Robot 2
...
# Complementary nailing operation to secure remaining members
