...
# L/U element placed by suction after pass
...
# Repetitive vertical studs along the panel
...
Nail_and_Release_Vertical_Element(el_name="Wooden_Element_6", X=1.2592, H=0.1016, Side_Selector=Wooden_Element_6_SS)
...
Nail_and_Release_Vertical_Element(el_name="Wooden_Element_7", X=1.2592, H=0.1016, Side_Selector=Wooden_Element_7_SS)
# Additional vertical studs at higher Y positions
...
# Jack studs tangent placement and nailing
...
Nail_2x10_Header(el_pose=[0.3514, 2.02, 0.0254], el_dims=[0.96, 0.0508, 0.254], conv_current_location=BL_13_CurConv)
# Second bear loading header
Pick_2x10_Header(X=0.3514, L=0.96)
Cut_2x10_Header(L=0.96, W=0.0508, H=0.254)
BL_14_CurConv = Place_2x10_Header(X=0.3514, Y=2.02, Z=0.0762, L=0.96, W=0.0508, H=0.254)
Nail_2x10_Header(el_pose=[0.3514, 2.02, 0.0762], el_dims=[0.96, 0.0508, 0.254], conv_current_location=BL_14_CurConv)
# Bottom plate placement and final complementary nailing
