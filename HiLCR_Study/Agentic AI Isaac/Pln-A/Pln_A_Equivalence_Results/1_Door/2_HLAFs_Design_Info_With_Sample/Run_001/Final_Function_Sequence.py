...
# Place first vertical king stud (F_Stud)
...
# Install L/U element with suction hand-off
...
# Install Wooden_Element_12 (left jack stud)
...
Nail_Vertical_Element_With_Tangent_to_an_Element(push_to_nail=0.01, el_pose=[1.4784, 1.56, 0], el_dims=[2.0, 0.04, 0.1016], If_Tangent_From_Left=True, Side_Selector=Wooden_Element_12_SS)
...
# Install Wooden_Element_11 (right jack stud)
...
Nail_Vertical_Element_With_Tangent_to_an_Element(push_to_nail=0.01, el_pose=[1.4784, 2.48, 0], el_dims=[2.0, 0.04, 0.1016], If_Tangent_From_Left=False, Side_Selector=Wooden_Element_11_SS)
...
# First 2x10 header (Wooden_Element_13)
Pick_2x10_Header(X=0.3514, L=0.96)
Cut_2x10_Header(L=0.96, W=0.0508, H=0.254)
BL_13_conv = Place_2x10_Header(X=0.3514, Y=2.02, Z=0.0254, L=0.96, W=0.0508, H=0.254)
Nail_2x10_Header(push_to_nail=0.025, el_pose=[0.3514, 2.02, 0.0254], el_dims=[0.96, 0.0508, 0.254], conv_current_location=BL_13_conv)
# Second 2x10 header (Wooden_Element_14)
Pick_2x10_Header(X=0.3514, L=0.96)
Cut_2x10_Header(L=0.96, W=0.0508, H=0.254)
BL_14_conv = Place_2x10_Header(X=0.3514, Y=2.02, Z=0.0762, L=0.96, W=0.0508, H=0.254)
Nail_2x10_Header(push_to_nail=0.025, el_pose=[0.3514, 2.02, 0.0762], el_dims=[0.96, 0.0508, 0.254], conv_current_location=BL_14_conv)
...
# Complementary nailing across the panel
