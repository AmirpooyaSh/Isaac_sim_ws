...
# Install the L/U stud next to the front stud
...
# Install repetitive right-hand studs along the bottom section
...
# Drop and nail the left jack stud
...
# Drop and nail the right jack stud
...
# Place and nail the first bearing header
...
# Place and nail the second bearing header
Pick_2x10_Header(X=0.3514, L=0.96)
Cut_2x10_Header(L=0.96, W=0.0508, H=0.254)
...
# Install remaining right-hand studs above the opening
...
# Complementary nailing across all stored positions
