...
# First vertical stud (F_Stud) sequence
...
# Place L/U stud using suction handoff
...
# Vertical stud R_Stud_2 sequence
...
# Vertical stud R_Stud_4 sequence
...
# Vertical stud R_Stud_6 sequence
...
# Vertical stud R_Stud_8 sequence
...
# King stud Wooden_Element_6 sequence
...
# King stud Wooden_Element_7 sequence
...
# Vertical stud R_Stud_18 sequence
...
# Vertical stud R_Stud_20 sequence
...
# Vertical stud R_Stud_22 sequence
...
# Vertical stud R_Stud_24 sequence
...
Nail_Vertical_Element_With_Tangent_to_an_Element(push_to_nail=0.05, el_pose=[1.4784, 1.56, 0.0], el_dims=[2.0, 0.04, 0.1016], If_Tangent_From_Left=True, Side_Selector=Wooden_Element_12_SS)
# Right jack stud sequence
...
Nail_Vertical_Element_With_Tangent_to_an_Element(push_to_nail=0.05, el_pose=[1.4784, 2.48, 0.0], el_dims=[2.0, 0.04, 0.1016], If_Tangent_From_Left=False, Side_Selector=Wooden_Element_11_SS)
# First 2x10 header placement and nailing
...
Nail_2x10_Header(push_to_nail=0.125, el_pose=[0.3514, 2.02, 0.0254], el_dims=[0.96, 0.0508, 0.254], conv_current_location=Wooden_Element_13_CurConv)
# Second 2x10 header placement and nailing
Pick_2x10_Header(X=0.3514, L=0.96)
Cut_2x10_Header(L=0.96, W=0.0508, H=0.254)
Wooden_Element_14_CurConv = Place_2x10_Header(X=0.3514, Y=2.02, Z=0.0762, L=0.96, W=0.0508, H=0.254)
Nail_2x10_Header(push_to_nail=0.125, el_pose=[0.3514, 2.02, 0.0762], el_dims=[0.96, 0.0508, 0.254], conv_current_location=Wooden_Element_14_CurConv)
