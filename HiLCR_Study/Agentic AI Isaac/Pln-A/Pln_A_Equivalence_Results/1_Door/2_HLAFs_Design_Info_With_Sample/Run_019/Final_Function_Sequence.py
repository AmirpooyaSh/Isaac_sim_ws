...
# Vertical studs before door opening
...
Nail_2x10_Header(push_to_nail=0.0625, el_pose=[0.3514, 2.02, 0.0254], el_dims=[0.96, 0.0508, 0.254], conv_current_location=Wooden_Element_13_Conv)
# Second header piece
Pick_2x10_Header(X=0.3514, L=0.96)
Cut_2x10_Header(L=0.96, W=0.0508, H=0.254)
Wooden_Element_14_Conv = Place_2x10_Header(X=0.3514, Y=2.02, Z=0.0762, L=0.96, W=0.0508, H=0.254)
Nail_2x10_Header(push_to_nail=0.0625, el_pose=[0.3514, 2.02, 0.0762], el_dims=[0.96, 0.0508, 0.254], conv_current_location=Wooden_Element_14_Conv)
# Vertical studs after door opening
...
# Complementary nail operation to secure remaining elements
