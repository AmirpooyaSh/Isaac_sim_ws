...
# Pick, hold, nail and release the front stud
...
# Pick, pass and place the L/U element with suction
...
# Pick, hold, nail and release right stud 1
...
# Pick, hold, nail and release left king stud 1
...
# Pick, hold, nail and release right king stud 1
...
# Place and nail left jack stud 1 (tangent)
...
# Place and nail right jack stud 1 (tangent)
...
# Pick, hold, nail and release right stud 2
...
# Pick, hold, nail and release left king stud 2
...
# Pick, hold, nail and release right king stud 2
...
# Place and nail left jack stud 2 (tangent)
...
# Place and nail right jack stud 2 (tangent)
...
BL_1_Place_CurConv = Place_2x10_Header(X=0.5514, Y=2.6876, Z=0.0254, L=0.86, W=0.0508, H=0.254)
Nail_2x10_Header(el_pose=[0.5514, 2.6876, 0.0254], el_dims=[0.86, 0.0508, 0.254], conv_current_location=BL_1_Place_CurConv)
# Bear loading header 2
Pick_2x10_Header(X=0.5514, L=0.86)
Cut_2x10_Header(L=0.86, W=0.0508, H=0.254)
BL_2_Place_CurConv = Place_2x10_Header(X=0.5514, Y=2.6876, Z=0.0762, L=0.86, W=0.0508, H=0.254)
Nail_2x10_Header(el_pose=[0.5514, 2.6876, 0.0762], el_dims=[0.86, 0.0508, 0.254], conv_current_location=BL_2_Place_CurConv)
# Bottom sill plate operations
...
# Pick, hold, nail and release right stud 3
