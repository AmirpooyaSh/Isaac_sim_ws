...
# Top Plate: pick, pass, and place on conveyor
...
# Full-height front stud: pick, place & nail
...
# L/U stud: pick, hand-off, place by suction
...
# Left King stud 1: pick, place & nail
...
# Right King stud 1: pick, place & nail
...
# Jack stud left 1: pick, drop tangent, nail
...
Nail_Vertical_Element_With_Tangent_to_an_Element(el_pose=[1.4784, 0.76, 0.0], el_dims=[2.0, 0.04, 0.1016], If_Tangent_From_Left=True, Side_Selector=LJ_1_SS)
# Jack stud right 1: pick, drop tangent, nail
...
Nail_Vertical_Element_With_Tangent_to_an_Element(el_pose=[1.4784, 1.64, 0.0], el_dims=[2.0, 0.04, 0.1016], If_Tangent_From_Left=False, Side_Selector=RJ_1_SS)
# Top sill plate: pick, pass, place horizontal, nail
...
Nail_Short_Horizontal_Element_by_Rob1_NailGun(el_pose=[0.4584, 1.2, 0.0], el_dims=[0.92, 0.04, 0.1016], conv_current_location=TSP_1_CurConv)
# Top cripple stud 1: pick, pass, place vertical, nail while still held
...
# Top cripple stud 2: pick, pass, place vertical, nail while held
...
# Top cripple stud 3: pick, pass, place vertical, nail while held
...
# Left King stud 2: pick, place & nail
...
# Right King stud 2: pick, place & nail
...
# Jack stud left 2: pick, drop tangent, nail
...
Nail_Vertical_Element_With_Tangent_to_an_Element(el_pose=[1.5784, 3.0976, 0.0], el_dims=[1.8, 0.04, 0.1016], If_Tangent_From_Left=True, Side_Selector=LJ_2_SS)
# Jack stud right 2: pick, drop tangent, nail
...
Nail_Vertical_Element_With_Tangent_to_an_Element(el_pose=[1.5784, 2.2776, 0.0], el_dims=[1.8, 0.04, 0.1016], If_Tangent_From_Left=False, Side_Selector=RJ_2_SS)
# Bear-loading header 1: pick, cut, place, nail
...
# Bear-loading header 2: pick, cut, place, nail
Pick_2x10_Header(X=0.5514, L=0.86)
Cut_2x10_Header(L=0.86, W=0.0508, H=0.254)
...
# Lower sill plate: pick, place horizontal with Rob2, nail
...
# Lower cripple stud 1: pick & place vertical (Rob2)
...
# Lower cripple stud 2: pick & place vertical (Rob2)
...
# Bottom plate: pick & place by Rob2
...
# Complementary nailing pass for any remaining verticals
