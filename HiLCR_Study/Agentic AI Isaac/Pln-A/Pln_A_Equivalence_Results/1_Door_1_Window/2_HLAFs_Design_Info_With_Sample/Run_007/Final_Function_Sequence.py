...
# Pick, hold and nail the front stud
...
# Pick, pass and place the L/U stud
...
# Pick, pass, place and nail Top Sill Plate
Pick_Short_Element_From_Mat_Supply(el_name="TSP_1", L=0.92, W=0.04, H=0.1016)
Pass_Short_Element_G2G(el_name="TSP_1", H=0.1016)
TS_Conv_Loc = Place_Short_Horizontal_Element_On_Smart_Conveyor_by_Rob1_Gripper(el_name="TSP_1", X=0.4584, Y=1.2, L=0.92, H=0.1016)
Nail_Short_Horizontal_Element_by_Rob1_NailGun(el_pose=[0.4584, 1.2, 0], el_dims=[0.92, 0.04, 0.1016], conv_current_location=TS_Conv_Loc)
...
Nail_Vertical_Element_With_Tangent_to_an_Element(el_pose=[1.5784, 3.0976, 0], el_dims=[1.8, 0.04, 0.1016], If_Tangent_From_Left=True, Side_Selector=LJ_2_SS)
...
Nail_Vertical_Element_With_Tangent_to_an_Element(el_pose=[1.5784, 2.2776, 0], el_dims=[1.8, 0.04, 0.1016], If_Tangent_From_Left=False, Side_Selector=RJ_2_SS)
...
Nail_Short_Horizontal_Element_by_Rob2_NailGun(el_pose=[1.8984, 2.6876, 0], el_dims=[0.78, 0.04, 0.1016], conv_current_location=BS_1_Conv)
# Pick and place LC_1
