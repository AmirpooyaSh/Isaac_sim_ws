...
# First king stud at panel start
...
# L/U stud via suction placement
...
# Left jack stud at door opening
...
# Right jack stud at door opening
...
Nail_2x10_Header(push_to_nail=0.125, el_pose=[0.5514, 2.6876, 0.0254], el_dims=[0.86, 0.0508, 0.254], conv_current_location=BL_1_Placement_CurConv)
# Second 2x10 header BL_2
Pick_2x10_Header(X=0.5514, L=0.86)
Cut_2x10_Header(L=0.86, W=0.0508, H=0.254)
BL_2_Placement_CurConv = Place_2x10_Header(X=0.5514, Y=2.6876, Z=0.0762, L=0.86, W=0.0508, H=0.254)
Nail_2x10_Header(push_to_nail=0.125, el_pose=[0.5514, 2.6876, 0.0762], el_dims=[0.86, 0.0508, 0.254], conv_current_location=BL_2_Placement_CurConv)
