...
# 2. First full-length vertical stud (F_Stud)
...
# 3. L-U stud placed by suction after robot-to-robot hand-off
...
# 4. Repetitive full-length vertical stud R_Stud_1
...
# 5. King studs around the door opening
...
# 6. Jack studs under the header (door sides)
...
# 7. Horizontal top sill plate above the window opening
...
# 8. Top cripple studs above the window
...
# 9. Additional full-length vertical studs (window/door framing continuation)
...
# 10. Second set of jack studs around window header
...
# 12. Lower sill plate under the window
...
# 13. Lower cripple studs below the sill
...
# 14. Final full-length stud at the far right of the panel
...
# 15. Bottom plate placement by Robot 2
...
# 16. Complementary nailing pass to finish any remaining studs
