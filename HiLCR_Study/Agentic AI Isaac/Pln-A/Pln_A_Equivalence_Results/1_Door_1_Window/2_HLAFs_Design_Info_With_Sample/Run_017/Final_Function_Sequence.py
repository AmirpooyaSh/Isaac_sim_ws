...
# Pick, pass, and place the top plate (Top_Stud)
...
# Process the first full-length vertical stud (F_Stud)
...
# Place the L/U header stud with suction (L_U_Element_1)
...
# Process right-side vertical stud R_Stud_1
...
# Left jack stud LJ_1 tangent to neighbouring stud
...
# Right jack stud RJ_1 tangent to neighbouring stud
...
# Top sill plate TSP_1 (short horizontal)
...
# Additional vertical stud R_Stud_2
...
# Lower sill plate BS_1 (short horizontal, Robot 2 places and nails)
...
# Additional vertical stud R_Stud_3
...
# Final complementary nailing along the panel height
