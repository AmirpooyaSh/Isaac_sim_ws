...
# L/U stud placement with suction
...
# Top sill plate horizontal element
...
Nail_2x10_Header(push_to_nail=0.025, el_pose=[0.5514, 2.6876, 0.0254], el_dims=[0.86, 0.0508, 0.254], conv_current_location=BL_1_CurConv)
...
Nail_2x10_Header(push_to_nail=0.025, el_pose=[0.5514, 2.6876, 0.0762], el_dims=[0.86, 0.0508, 0.254], conv_current_location=BL_2_CurConv)
# Lower sill plate
