...
Nail_and_Release_Vertical_Element(el_name="F_Stud", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=F_Stud_SS, Is_Held=False)
# --- L/U Element ---
...
Nail_and_Release_Vertical_Element(el_name="R_Stud_1", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=R_Stud_1_SS, Is_Held=False)
# --- LK_1 ---
...
Nail_and_Release_Vertical_Element(el_name="LK_1", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=LK_1_SS, Is_Held=False)
# --- RK_1 ---
...
Nail_and_Release_Vertical_Element(el_name="RK_1", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=RK_1_SS, Is_Held=False)
# --- Jack Stud LJ_1 ---
...
TSP_1_ConvLoc = Place_Short_Horizontal_Element_On_Smart_Conveyor_by_Rob1_Gripper(el_name="TSP_1", X=0.4584, Y=1.2, L=0.92, H=0.1016)
Nail_Short_Horizontal_Element_by_Rob1_NailGun(push_to_nail=0.01, el_pose=[0.4584, 1.2, 0.0], el_dims=[0.92, 0.04, 0.1016], conv_current_location=TSP_1_ConvLoc)
...
Nail_and_Release_Vertical_Element(el_name="R_Stud_2", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=R_Stud_2_SS, Is_Held=False)
# --- LK_2 ---
...
Nail_and_Release_Vertical_Element(el_name="LK_2", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=LK_2_SS, Is_Held=False)
# --- RK_2 ---
...
Nail_and_Release_Vertical_Element(el_name="RK_2", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=RK_2_SS, Is_Held=False)
# --- Jack Stud LJ_2 ---
...
Nail_2x10_Header(push_to_nail=0.0625, el_pose=[0.5514, 2.6876, 0.0254], el_dims=[0.86, 0.0508, 0.254], conv_current_location=BL_1_Conv)
# --- Bear Loading BL_2 ---
Pick_2x10_Header(X=0.5514, L=0.86)
Cut_2x10_Header(L=0.86, W=0.0508, H=0.254)
BL_2_Conv = Place_2x10_Header(X=0.5514, Y=2.6876, Z=0.0762, L=0.86, W=0.0508, H=0.254)
Nail_2x10_Header(push_to_nail=0.0625, el_pose=[0.5514, 2.6876, 0.0762], el_dims=[0.86, 0.0508, 0.254], conv_current_location=BL_2_Conv)
# --- Lower Sill Plate BS_1 ---
...
Nail_Short_Horizontal_Element_by_Rob2_NailGun(push_to_nail=0.01, el_pose=[1.8984, 2.6876, 0.0], el_dims=[0.78, 0.04, 0.1016], conv_current_location=BS_1_Conv)
...
Nail_and_Release_Vertical_Element(el_name="R_Stud_3", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=R_Stud_3_SS, Is_Held=False)
# --- Bottom Plate ---
