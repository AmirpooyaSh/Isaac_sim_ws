...
LJ_2_SS = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name="LJ_2", X=1.5784, Y=3.0976, L=1.8, H=0.1016, If_Tangent_From_Left=True)
Nail_Vertical_Element_With_Tangent_to_an_Element(push_to_nail=0.01, el_pose=[1.5784, 3.0976, 0.0], el_dims=[1.8, 0.04, 0.1016], If_Tangent_From_Left=True, Side_Selector=LJ_2_SS)
# ---- Right Jack Stud 2 ----
Pick_Short_Element_From_Mat_Supply(el_name="RJ_2", L=1.8, W=0.04, H=0.1016)
RJ_2_SS = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name="RJ_2", X=1.5784, Y=2.2776, L=1.8, H=0.1016, If_Tangent_From_Left=False)
Nail_Vertical_Element_With_Tangent_to_an_Element(push_to_nail=0.01, el_pose=[1.5784, 2.2776, 0.0], el_dims=[1.8, 0.04, 0.1016], If_Tangent_From_Left=False, Side_Selector=RJ_2_SS)
# ---- Header BL_1 ----
