...
# Pick, place and nail first vertical stud (F_Stud)
...
# Pick, pass and place L/U element with suction
...
# Pick, drop and nail LJ_1 tangent from left
...
# Pick, drop and nail RJ_1 tangent from right
...
# Pick, pass, place and nail top sill plate TSP_1
...
# Pick, drop and nail LJ_2 tangent from left
...
# Pick, drop and nail RJ_2 tangent from right
...
# Pick, cut, place and nail header BL_1
...
Nail_2x10_Header(el_pose=[0.5514, 2.6876, 0.0254], el_dims=[0.86, 0.0508, 0.254], conv_current_location=BL_1_CurConv)
# Pick, cut, place and nail header BL_2
Pick_2x10_Header(X=0.5514, L=0.96)
Cut_2x10_Header(L=0.86, W=0.0508, H=0.254)
BL_2_CurConv = Place_2x10_Header(X=0.5514, Y=2.6876, Z=0.0762, L=0.86, W=0.0508, H=0.254)
Nail_2x10_Header(el_pose=[0.5514, 2.6876, 0.0762], el_dims=[0.86, 0.0508, 0.254], conv_current_location=BL_2_CurConv)
...
# Complementary nailing on recorded nail poses
