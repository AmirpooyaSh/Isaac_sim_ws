...
# First full-length vertical stud
...
# L/U stud handled via suction transfer
...
# Repetitive full-length vertical studs along the opening
...
# Left and right jack studs for the door opening
...
# Top sill plate over the window opening
...
# Top cripple studs above the window opening
...
# Additional full-length studs further along the wall
...
# Lower sill plate beneath window
...
# Lower cripple studs under window
...
# Final long stud near panel end
...
# Complementary nailing pass for remaining cripples
