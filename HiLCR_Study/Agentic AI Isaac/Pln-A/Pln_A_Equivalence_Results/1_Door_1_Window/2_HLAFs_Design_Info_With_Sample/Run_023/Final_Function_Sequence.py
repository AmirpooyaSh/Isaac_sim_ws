...
# Pick, place, nail the front stud
...
Nail_and_Release_Vertical_Element(el_name="R_Stud_1", X=1.2592, H=0.1016, Side_Selector=R_Stud_1_SS)
# Right stud 2 sequence
...
Nail_and_Release_Vertical_Element(el_name="LK_1", X=1.2592, H=0.1016, Side_Selector=LK_1_SS)
# Right king stud 1
...
Nail_and_Release_Vertical_Element(el_name="RK_1", X=1.2592, H=0.1016, Side_Selector=RK_1_SS)
# Left jack stud 1 tangent placement and nailing
...
# Right jack stud 1 tangent placement and nailing
...
Nail_and_Release_Vertical_Element(el_name="R_Stud_3", X=1.2592, H=0.1016, Side_Selector=R_Stud_3_SS)
# Left king stud 2
...
Nail_and_Release_Vertical_Element(el_name="LK_2", X=1.2592, H=0.1016, Side_Selector=LK_2_SS)
# Right king stud 2
...
Nail_and_Release_Vertical_Element(el_name="RK_2", X=1.2592, H=0.1016, Side_Selector=RK_2_SS)
# Left jack stud 2 tangent placement and nailing
...
Nail_Vertical_Element_With_Tangent_to_an_Element(el_pose=[1.5784, 2.2776, 0.0], el_dims=[1.8, 0.04, 0.1016], If_Tangent_From_Left=True, Side_Selector=LJ_2_SS)
# Right jack stud 2 tangent placement and nailing
...
Nail_Vertical_Element_With_Tangent_to_an_Element(el_pose=[1.5784, 3.0976, 0.0], el_dims=[1.8, 0.04, 0.1016], If_Tangent_From_Left=False, Side_Selector=RJ_2_SS)
# First bear loading header
...
# Lower sill plate horizontal placement and nailing by Robot 2
...
# Lower cripple stud 1 placed by Robot 2
...
# Lower cripple stud 2 placed by Robot 2
