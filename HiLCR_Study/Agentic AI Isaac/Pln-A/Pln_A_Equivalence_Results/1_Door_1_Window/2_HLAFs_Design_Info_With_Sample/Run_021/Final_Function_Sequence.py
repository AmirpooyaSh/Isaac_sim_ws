...
# L/U stud transferred by suction
...
Nail_Short_Horizontal_Element_by_Rob1_NailGun(el_pose=[0.4584, 1.2, 0], el_dims=[0.92, 0.04, 0.1016], conv_current_location=TS_1_CurConv)
...
# Complementary nail operation for remaining studs
