...
L_Jack_1_SS = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name="LJ_1", X=1.4784, Y=0.76, L=2.0, H=0.1016, If_Tangent_From_Left=True)
Nail_Vertical_Element_With_Tangent_to_an_Element(el_pose=[1.4784, 0.76, 0.0], el_dims=[2.0, 0.04, 0.1016], If_Tangent_From_Left=True, Side_Selector=L_Jack_1_SS)
# Right Jack Stud 1
Pick_Short_Element_From_Mat_Supply(el_name="RJ_1", L=2.0, W=0.04, H=0.1016)
R_Jack_1_SS = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name="RJ_1", X=1.4784, Y=1.64, L=2.0, H=0.1016, If_Tangent_From_Left=False)
Nail_Vertical_Element_With_Tangent_to_an_Element(el_pose=[1.4784, 1.64, 0.0], el_dims=[2.0, 0.04, 0.1016], If_Tangent_From_Left=False, Side_Selector=R_Jack_1_SS)
# Top Sill Plate
Pick_Short_Element_From_Mat_Supply(el_name="TSP_1", L=0.92, W=0.04, H=0.1016)
Pass_Short_Element_G2G(el_name="TSP_1", H=0.1016)
TS_1_CurConv = Place_Short_Horizontal_Element_On_Smart_Conveyor_by_Rob1_Gripper(el_name="TSP_1", X=0.4584, Y=1.2, L=0.92, H=0.1016)
Nail_Short_Horizontal_Element_by_Rob1_NailGun(el_pose=[0.4584, 1.2, 0.0], el_dims=[0.92, 0.04, 0.1016], conv_current_location=TS_1_CurConv)
...
TC_1_SS = Place_Short_Vertical_Element_On_Smart_Conveyor_by_Rob1_Gripper(el_name="TCP_1", X=0.2392, Y=1.2, L=0.3984, H=0.1016)
Nail_and_Release_Vertical_Element(el_name="TCP_1", X=0.2392, L=0.3984, H=0.1016, Side_Selector=TC_1_SS, Is_Held=True)
...
TC_2_SS = Place_Short_Vertical_Element_On_Smart_Conveyor_by_Rob1_Gripper(el_name="TCP_2", X=0.2392, Y=0.98, L=0.3984, H=0.1016)
Nail_and_Release_Vertical_Element(el_name="TCP_2", X=0.2392, L=0.3984, H=0.1016, Side_Selector=TC_2_SS, Is_Held=True)
...
TC_3_SS = Place_Short_Vertical_Element_On_Smart_Conveyor_by_Rob1_Gripper(el_name="TCP_3", X=0.2392, Y=1.42, L=0.3984, H=0.1016)
Nail_and_Release_Vertical_Element(el_name="TCP_3", X=0.2392, L=0.3984, H=0.1016, Side_Selector=TC_3_SS, Is_Held=True)
# Right Stud 2
...
L_Jack_2_SS = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name="LJ_2", X=1.5784, Y=2.2776, L=1.8, H=0.1016, If_Tangent_From_Left=True)
Nail_Vertical_Element_With_Tangent_to_an_Element(el_pose=[1.5784, 2.2776, 0.0], el_dims=[1.8, 0.04, 0.1016], If_Tangent_From_Left=True, Side_Selector=L_Jack_2_SS)
# Right Jack Stud 2
Pick_Short_Element_From_Mat_Supply(el_name="RJ_2", L=1.8, W=0.04, H=0.1016)
R_Jack_2_SS = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name="RJ_2", X=1.5784, Y=3.0976, L=1.8, H=0.1016, If_Tangent_From_Left=False)
Nail_Vertical_Element_With_Tangent_to_an_Element(el_pose=[1.5784, 3.0976, 0.0], el_dims=[1.8, 0.04, 0.1016], If_Tangent_From_Left=False, Side_Selector=R_Jack_2_SS)
...
Nail_Short_Horizontal_Element_by_Rob2_NailGun(el_pose=[1.8984, 2.6876, 0.0], el_dims=[0.78, 0.04, 0.1016], conv_current_location=BS_1_CurConv)
