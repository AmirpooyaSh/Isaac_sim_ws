...
# Door Opening – Header (Top Sill Plate)
...
# Window Opening – Bear Loading Header Board 1 (BL_1)
...
# Window Opening – Bear Loading Header Board 2 (BL_2)
...
# Complementary nailing operation for bottom plate and any remaining verticals
