...
# Install L/U Stud adjacent to first stud
...
# Install Left King Stud for first opening
...
# Install Right King Stud for first opening
...
# Install Left Jack Stud for window
...
# Install Right Jack Stud for window
...
# Install Top Sill Plate above opening
...
# Install Left King Stud for second opening
...
# Install Right King Stud for second opening
...
# Install Left Jack Stud for door
Pick_Short_Element_From_Mat_Supply(el_name="LJ_2", L=1.8, W=0.04, H=0.1016)
side_LJ_2 = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name="LJ_2", X=1.5784, Y=3.0976, L=1.8, H=0.1016, If_Tangent_From_Left=True)
...
# Install Right Jack Stud for door
Pick_Short_Element_From_Mat_Supply(el_name="RJ_2", L=1.8, W=0.04, H=0.1016)
side_RJ_2 = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name="RJ_2", X=1.5784, Y=2.2776, L=1.8, H=0.1016, If_Tangent_From_Left=False)
...
# Install first Bear Loading header BL_1
...
# Install second Bear Loading header BL_2
Pick_2x10_Header(X=0.5514, L=0.86)
...
# Install Vertical Stud R_Stud_1
...
# Install Vertical Stud R_Stud_3
...
Nail_Short_Horizontal_Element_by_Rob2_NailGun(el_pose=[2.4984, 1.8288, 0.06], el_dims=[3.6576, 0.04, 0.1016], conv_current_location=0.0)
# Install OSB Sheathing Plate
Pick_OSB_Plate(el_name="OSB_1", L=2.44, W=1.22, H=0.012)
Sht_loc = Place_OSB_Plate(el_name="OSB_1", X=1.0, Y=1.8288, Z=0.0)
Nail_OSB_Plate(el_dims=[2.44, 1.22, 0.012], Sht_plate_on_conv_loc=Sht_loc)
