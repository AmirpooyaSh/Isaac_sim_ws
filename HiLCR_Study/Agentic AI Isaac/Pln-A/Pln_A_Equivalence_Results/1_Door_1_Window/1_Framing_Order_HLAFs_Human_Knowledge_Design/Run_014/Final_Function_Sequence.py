...
# Install L/U Stud after first stud
...
Nail_Vertical_Element_With_Tangent_to_an_Element(push_to_nail=0.01, el_pose=[1.4784, 1.64, 0.0], el_dims=[2.0, 0.04, 0.1016], If_Tangent_From_Left=False, Side_Selector=side_RJ_1)
# Install Door Top Sill Plate (TSP_1)
...
# Install Top Cripple Stud TCP_1 over door
...
# Install Window Left King Stud (LK_2)
...
# Install Window Right King Stud (RK_2)
...
# Install Window Left Jack Stud (LJ_2)
...
Nail_Vertical_Element_With_Tangent_to_an_Element(push_to_nail=0.01, el_pose=[1.5784, 3.0976, 0.0], el_dims=[1.8, 0.04, 0.1016], If_Tangent_From_Left=True, Side_Selector=side_LJ_2)
# Install Window Right Jack Stud (RJ_2)
...
Nail_Vertical_Element_With_Tangent_to_an_Element(push_to_nail=0.01, el_pose=[1.5784, 2.2776, 0.0], el_dims=[1.8, 0.04, 0.1016], If_Tangent_From_Left=False, Side_Selector=side_RJ_2)
...
Nail_2x10_Header(push_to_nail=0.025, el_pose=[0.5514, 2.6876, 0.0254], el_dims=[0.86, 0.0508, 0.254], conv_current_location=conv_BL_1)
# Install Window Header Bear Loading BL_2 (stacked)
Pick_2x10_Header(X=0.5514, L=0.86)
Cut_2x10_Header(L=0.86, W=0.0508, H=0.254)
conv_BL_2 = Place_2x10_Header(X=0.5514, Y=2.6876, Z=0.0762, L=0.86, W=0.0508, H=0.254)
Nail_2x10_Header(push_to_nail=0.025, el_pose=[0.5514, 2.6876, 0.0762], el_dims=[0.86, 0.0508, 0.254], conv_current_location=conv_BL_2)
...
Nail_Short_Horizontal_Element_by_Rob1_NailGun(push_to_nail=0.01, el_pose=[1.8984, 2.6876, 0.0], el_dims=[0.78, 0.04, 0.1016], conv_current_location=conv_BS_1)
# Install Lower Cripple Stud LC_1
Pick_Short_Element_From_Mat_Supply(el_name='LC_1', L=0.56, W=0.04, H=0.1016)
side_LC_1 = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name='LC_1', X=2.1984, Y=2.5376, L=0.56, H=0.1016, If_Tangent_From_Left=True)
# Install Lower Cripple Stud LC_2
Pick_Short_Element_From_Mat_Supply(el_name='LC_2', L=0.56, W=0.04, H=0.1016)
side_LC_2 = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name='LC_2', X=2.1984, Y=2.8376, L=0.56, H=0.1016, If_Tangent_From_Left=False)
