...
# Install standard vertical stud in next bay
...
# Door Header - Bear Loading plank 1
...
Nail_Short_Horizontal_Element_by_Rob1_NailGun(el_pose=[0.5514, 2.6876, 0.0254], el_dims=[0.86, 0.0508, 0.254], conv_current_location=conv_BL_1)
# Door Header - Bear Loading plank 2
...
Nail_Short_Horizontal_Element_by_Rob1_NailGun(el_pose=[0.5514, 2.6876, 0.0762], el_dims=[0.86, 0.0508, 0.254], conv_current_location=conv_BL_2)
# Install standard vertical stud after door opening
...
# Standard vertical stud at far right end
...
# Complementary nailing of remaining vertical holds and plates
