...
# Install Window Opening Left King Stud 'LK_1'
...
# Install Window Opening Right King Stud 'RK_1'
...
# Install Window Opening Left Jack Stud 'LJ_1'
...
Nail_and_Release_Vertical_Element(el_name="LJ_1", X=1.4784, L=2.0, H=0.1016, Side_Selector=side_LJ_1, Is_Held=False)
# Install Window Opening Right Jack Stud 'RJ_1'
...
Nail_and_Release_Vertical_Element(el_name="RJ_1", X=1.4784, L=2.0, H=0.1016, Side_Selector=side_RJ_1, Is_Held=False)
...
Nail_Vertical_Element_With_Tangent_to_an_Element(el_pose=[0.2392, 1.2, 0.0], el_dims=[0.3984, 0.04, 0.1016], Side_Selector=side_TCP_1)
...
# Install Door Opening Right King Stud 'RK_2'
...
# Install Door Opening Right Jack Stud 'RJ_2'
...
Nail_and_Release_Vertical_Element(el_name="RJ_2", X=1.5784, L=1.8, H=0.1016, Side_Selector=side_RJ_2, Is_Held=False)
# Install Door Opening Left Jack Stud 'LJ_2'
...
Nail_and_Release_Vertical_Element(el_name="LJ_2", X=1.5784, L=1.8, H=0.1016, Side_Selector=side_LJ_2, Is_Held=False)
# Install Door Opening Left King Stud 'LK_2'
...
# Install Bear Loading Header Board 1
...
# Install Bear Loading Header Board 2
Pick_2x10_Header(X=0.5514, L=0.86)
Cut_2x10_Header(L=0.86, W=0.0508, H=0.254)
...
Nail_Short_Horizontal_Element_by_Rob2_NailGun(el_pose=[1.8984, 2.6876, 0.0], el_dims=[0.78, 0.04, 0.1016], conv_current_location=conv_BS_1)
...
# Install OSB Sheathing Plate 'OSB_1'
Pick_OSB_Plate(el_name="OSB_1", L=2.44, W=1.22, H=0.012)
conv_OSB = Place_OSB_Plate(el_name="OSB_1", X=1.8288, Y=1.8288, Z=0.0)
Nail_OSB_Plate(el_dims=[2.44, 1.22, 0.012], Sht_plate_on_conv_loc=conv_OSB)
