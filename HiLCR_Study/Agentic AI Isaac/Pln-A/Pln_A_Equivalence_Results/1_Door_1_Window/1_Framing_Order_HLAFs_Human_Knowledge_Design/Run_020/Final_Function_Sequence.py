...
# Install Top Plate across full wall length
...
# Optional L/U Stud immediately after first standard stud
...
side_LJ_1 = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name='LJ_1', X=1.4784, Y=0.76, L=2.0, H=0.1016, If_Tangent_From_Left=True)
...
side_RJ_1 = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name='RJ_1', X=1.4784, Y=1.64, L=2.0, H=0.1016, If_Tangent_From_Left=False)
...
# Window Opening – King Stud Right
...
Nail_Vertical_Element_With_Tangent_to_an_Element(el_pose=[1.5784, 2.2776, 0.0], el_dims=[1.8, 0.04, 0.1016], If_Tangent_From_Left=True, Side_Selector=side_RJ_2)
...
Nail_Vertical_Element_With_Tangent_to_an_Element(el_pose=[1.5784, 3.0976, 0.0], el_dims=[1.8, 0.04, 0.1016], If_Tangent_From_Left=False, Side_Selector=side_LJ_2)
# Window Opening – Bear Loading Header Plank 1
...
# Window Opening – Bear Loading Header Plank 2
Pick_2x10_Header(X=0.5514, L=0.86)
Cut_2x10_Header(L=0.86, W=0.0508, H=0.254)
conv_BL_2 = Place_2x10_Header(X=0.5514, Y=2.6876, Z=0.0762, L=0.86, W=0.0508, H=0.254)
Nail_2x10_Header(el_pose=[0.5514, 2.6876, 0.0762], el_dims=[0.86, 0.0508, 0.254], conv_current_location=conv_BL_2)
...
# Window Opening – Lower Cripple Stud 1
...
# Window Opening – Lower Cripple Stud 2
...
# Install Bottom Plate across the wall
...
# Complementary nailing pass for bottom plate and accumulated nail poses
