...
# Install second Vertical Stud (R_Stud_1)
Pick_8ft_Element_From_Sloped_Table(el_name="R_Stud_1", L=2.4384, W=0.04, H=0.1016)
side_sel_R_Stud_1 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.2592, Y=0.5, L=2.4384, H=0.1016)
Nail_and_Release_Vertical_Element(el_name="R_Stud_1", X=1.2592, L=2.4384, H=0.1016, Side_Selector=side_sel_R_Stud_1, Is_Held=False)
# Install Left King Stud for Door (LK_1)
...
# Install Right King Stud for Door (RK_1)
...
# Install Left Jack Stud for Door (LJ_1)
...
# Install Right Jack Stud for Door (RJ_1)
...
# Install Top Sill Plate over Door (TSP_1)
...
# Install Vertical Stud between Door and Window (R_Stud_2)
Pick_8ft_Element_From_Sloped_Table(el_name="R_Stud_2", L=2.4384, W=0.04, H=0.1016)
side_sel_R_Stud_2 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.2592, Y=1.9588, L=2.4384, H=0.1016)
...
# Install Left King Stud for Window (LK_2)
...
# Install Right King Stud for Window (RK_2)
...
# Install Left Jack Stud for Window (LJ_2)
...
# Install Right Jack Stud for Window (RJ_2)
...
# Install Bear Loading Header plank 1 (BL_1)
...
# Install Bear Loading Header plank 2 (BL_2)
...
# Install Lower Sill Plate for Window (BS_1)
...
Nail_Short_Horizontal_Element_by_Rob1_NailGun(push_to_nail=0.01, el_pose=[1.8984, 2.6876, 0.0], el_dims=[0.78, 0.04, 0.1016], conv_current_location=conv_BS1)
...
# Install final Vertical Stud (R_Stud_3)
Pick_8ft_Element_From_Sloped_Table(el_name="R_Stud_3", L=2.4384, W=0.04, H=0.1016)
side_sel_R_Stud_3 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.2592, Y=3.6376, L=2.4384, H=0.1016)
Nail_and_Release_Vertical_Element(el_name="R_Stud_3", X=1.2592, L=2.4384, H=0.1016, Side_Selector=side_sel_R_Stud_3, Is_Held=False)
...
# Complementary nailing of plates and remaining positions
