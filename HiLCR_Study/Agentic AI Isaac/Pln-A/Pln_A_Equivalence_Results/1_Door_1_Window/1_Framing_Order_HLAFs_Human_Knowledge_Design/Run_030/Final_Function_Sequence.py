...
side_R_Stud1 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.2592, Y=0.5, L=2.4384, H=0.1016)
Nail_and_Release_Vertical_Element(el_name="R_Stud_1", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_R_Stud1, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name="LK_1", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_LK1, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name="RK_1", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_RK1, Is_Held=False)
# Install Left Jack Stud LJ_1
Pick_Long_Element_From_Mat_Supply(el_name="LJ_1", L=2.0, W=0.04, H=0.1016)
side_LJ1 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.4784, Y=0.76, L=2.0, H=0.1016)
Nail_and_Release_Vertical_Element(el_name="LJ_1", X=1.4784, push_to_nail=0.05, L=2.0, H=0.1016, Side_Selector=side_LJ1, Is_Held=False)
# Install Right Jack Stud RJ_1
Pick_Long_Element_From_Mat_Supply(el_name="RJ_1", L=2.0, W=0.04, H=0.1016)
side_RJ1 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.4784, Y=1.64, L=2.0, H=0.1016)
Nail_and_Release_Vertical_Element(el_name="RJ_1", X=1.4784, push_to_nail=0.05, L=2.0, H=0.1016, Side_Selector=side_RJ1, Is_Held=False)
...
Nail_Short_Horizontal_Element_by_Rob1_NailGun(push_to_nail=0.01, el_pose=[0.4584, 1.2, 0.0], el_dims=[0.92, 0.04, 0.1016], conv_current_location=conv_TSP)
...
side_R_Stud2 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.2592, Y=1.9588, L=2.4384, H=0.1016)
Nail_and_Release_Vertical_Element(el_name="R_Stud_2", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_R_Stud2, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name="LK_2", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_LK2, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name="RK_2", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_RK2, Is_Held=False)
# Install Left Jack Stud LJ_2
Pick_Long_Element_From_Mat_Supply(el_name="LJ_2", L=1.8, W=0.04, H=0.1016)
side_LJ2 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.5784, Y=3.0976, L=1.8, H=0.1016)
Nail_and_Release_Vertical_Element(el_name="LJ_2", X=1.5784, push_to_nail=0.05, L=1.8, H=0.1016, Side_Selector=side_LJ2, Is_Held=False)
# Install Right Jack Stud RJ_2
Pick_Long_Element_From_Mat_Supply(el_name="RJ_2", L=1.8, W=0.04, H=0.1016)
side_RJ2 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.5784, Y=2.2776, L=1.8, H=0.1016)
Nail_and_Release_Vertical_Element(el_name="RJ_2", X=1.5784, push_to_nail=0.05, L=1.8, H=0.1016, Side_Selector=side_RJ2, Is_Held=False)
...
side_R_Stud3 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.2592, Y=3.6376, L=2.4384, H=0.1016)
Nail_and_Release_Vertical_Element(el_name="R_Stud_3", X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_R_Stud3, Is_Held=False)
# Install Bottom Plate Bot_Stud
