...
side_LJ_1 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.4784, Y=0.76, L=2.0, H=0.1016)
...
side_RJ_1 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.4784, Y=1.64, L=2.0, H=0.1016)
Nail_and_Release_Vertical_Element(el_name='RJ_1', X=1.4784, L=2.0, H=0.1016, Side_Selector=side_RJ_1, Is_Held=False)
# Install Top Sill Plate over Door Opening (TSP_1)
...
Nail_Vertical_Element_With_Tangent_to_an_Element(el_pose=[0.2392, 0.98, 0.0], el_dims=[0.3984, 0.04, 0.1016], Side_Selector=side_TCP_2)
...
Nail_Vertical_Element_With_Tangent_to_an_Element(el_pose=[0.2392, 1.42, 0.0], el_dims=[0.3984, 0.04, 0.1016], Side_Selector=side_TCP_3)
...
side_LJ_2 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.5784, Y=3.0976, L=1.8, H=0.1016)
...
side_RJ_2 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.5784, Y=2.2776, L=1.8, H=0.1016)
Nail_and_Release_Vertical_Element(el_name='RJ_2', X=1.5784, L=1.8, H=0.1016, Side_Selector=side_RJ_2, Is_Held=False)
# Install Window Header Bear Loading plank 1 (BL_1)
...
Nail_Short_Horizontal_Element_by_Rob2_NailGun(el_pose=[0.5514, 2.6876, 0.0254], el_dims=[0.86, 0.0508, 0.254], conv_current_location=conv_BL_1)
# Install Window Header Bear Loading plank 2 (BL_2)
...
Nail_Short_Horizontal_Element_by_Rob2_NailGun(el_pose=[0.5514, 2.6876, 0.0762], el_dims=[0.86, 0.0508, 0.254], conv_current_location=conv_BL_2)
...
# Install Window Lower Cripple Stud LC_1 (no nail required)
...
# Install Window Lower Cripple Stud LC_2 (no nail required)
...
# Install final standard Vertical Stud (R_Stud_3)
