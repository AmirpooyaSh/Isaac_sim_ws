...
# Install F_Stud Standard Vertical Stud
...
# Install R_Stud_1 Standard Vertical Stud
...
# Install LJ_1 Left Jack Stud
Pick_Short_Element_From_Mat_Supply(el_name='LJ_1', L=2.0, W=0.04, H=0.1016)
side_LJ_1 = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name='LJ_1', X=1.4784, Y=0.76, L=2.0, H=0.1016, If_Tangent_From_Left=False)
Nail_Vertical_Element_With_Tangent_to_an_Element(push_to_nail=0.01, el_pose=[1.4784, 0.76, 0.0], el_dims=[2.0, 0.04, 0.1016], If_Tangent_From_Left=False, Side_Selector=side_LJ_1)
# Install RJ_1 Right Jack Stud
Pick_Short_Element_From_Mat_Supply(el_name='RJ_1', L=2.0, W=0.04, H=0.1016)
side_RJ_1 = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name='RJ_1', X=1.4784, Y=1.64, L=2.0, H=0.1016, If_Tangent_From_Left=True)
Nail_Vertical_Element_With_Tangent_to_an_Element(push_to_nail=0.01, el_pose=[1.4784, 1.64, 0.0], el_dims=[2.0, 0.04, 0.1016], If_Tangent_From_Left=True, Side_Selector=side_RJ_1)
# Install TSP_1 Top Sill Plate
...
Nail_Short_Horizontal_Element_by_Rob1_NailGun(push_to_nail=0.01, el_pose=[0.4584, 1.2, 0.0], el_dims=[0.92, 0.04, 0.1016], conv_current_location=conv_TSP_1)
# Install TCP_1 Top Cripple Stud
...
Nail_Vertical_Element_With_Tangent_to_an_Element(push_to_nail=0.01, el_pose=[0.2392, 1.2, 0.0], el_dims=[0.3984, 0.04, 0.1016], If_Tangent_From_Left=False, Side_Selector=side_TCP_1)
# Install TCP_2 Top Cripple Stud
...
Nail_Vertical_Element_With_Tangent_to_an_Element(push_to_nail=0.01, el_pose=[0.2392, 0.98, 0.0], el_dims=[0.3984, 0.04, 0.1016], If_Tangent_From_Left=False, Side_Selector=side_TCP_2)
# Install TCP_3 Top Cripple Stud
...
Nail_Vertical_Element_With_Tangent_to_an_Element(push_to_nail=0.01, el_pose=[0.2392, 1.42, 0.0], el_dims=[0.3984, 0.04, 0.1016], If_Tangent_From_Left=False, Side_Selector=side_TCP_3)
# Install R_Stud_2 Standard Vertical Stud
...
# Install LJ_2 Left Jack Stud
Pick_Short_Element_From_Mat_Supply(el_name='LJ_2', L=1.8, W=0.04, H=0.1016)
side_LJ_2 = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name='LJ_2', X=1.5784, Y=3.0976, L=1.8, H=0.1016, If_Tangent_From_Left=False)
Nail_Vertical_Element_With_Tangent_to_an_Element(push_to_nail=0.01, el_pose=[1.5784, 3.0976, 0.0], el_dims=[1.8, 0.04, 0.1016], If_Tangent_From_Left=False, Side_Selector=side_LJ_2)
# Install RJ_2 Right Jack Stud
Pick_Short_Element_From_Mat_Supply(el_name='RJ_2', L=1.8, W=0.04, H=0.1016)
side_RJ_2 = Drop_Short_Vertical_Element_With_Tangent_to_an_Element(el_name='RJ_2', X=1.5784, Y=2.2776, L=1.8, H=0.1016, If_Tangent_From_Left=True)
Nail_Vertical_Element_With_Tangent_to_an_Element(push_to_nail=0.01, el_pose=[1.5784, 2.2776, 0.0], el_dims=[1.8, 0.04, 0.1016], If_Tangent_From_Left=True, Side_Selector=side_RJ_2)
# Install BL_1 Bear Loading Header
Pick_Short_Element_From_Mat_Supply(el_name='BL_1', L=0.86, W=0.0508, H=0.254)
conv_BL_1 = Place_Short_Horizontal_Element_On_Smart_Conveyor_by_Rob2_Gripper(el_name='BL_1', X=0.5514, Y=2.6876, L=0.86, H=0.254)
Nail_Short_Horizontal_Element_by_Rob2_NailGun(push_to_nail=0.01, el_pose=[0.5514, 2.6876, 0.0254], el_dims=[0.86, 0.0508, 0.254], conv_current_location=conv_BL_1)
# Install BL_2 Bear Loading Header stacked
Pick_Short_Element_From_Mat_Supply(el_name='BL_2', L=0.86, W=0.0508, H=0.254)
conv_BL_2 = Place_Short_Horizontal_Element_On_Smart_Conveyor_by_Rob2_Gripper(el_name='BL_2', X=0.5514, Y=2.6876, L=0.86, H=0.254)
Nail_Short_Horizontal_Element_by_Rob2_NailGun(push_to_nail=0.01, el_pose=[0.5514, 2.6876, 0.0762], el_dims=[0.86, 0.0508, 0.254], conv_current_location=conv_BL_2)
# Install BS_1 Lower Sill Plate
Pick_Short_Element_From_Mat_Supply(el_name='BS_1', L=0.78, W=0.04, H=0.1016)
conv_BS_1 = Place_Short_Horizontal_Element_On_Smart_Conveyor_by_Rob2_Gripper(el_name='BS_1', X=1.8984, Y=2.6876, L=0.78, H=0.1016)
Nail_Short_Horizontal_Element_by_Rob2_NailGun(push_to_nail=0.01, el_pose=[1.8984, 2.6876, 0.0], el_dims=[0.78, 0.04, 0.1016], conv_current_location=conv_BS_1)
# Install LC_1 Lower Cripple Stud
...
# Install LC_2 Lower Cripple Stud
...
# Install R_Stud_3 Standard Vertical Stud
...
conv_Bot_Stud = Place_Short_Horizontal_Element_On_Smart_Conveyor_by_Rob1_Gripper(el_name='Bot_Stud', X=2.4984, Y=1.8288, L=3.6576, H=0.1016)
Nail_Short_Horizontal_Element_by_Rob1_NailGun(push_to_nail=0.01, el_pose=[2.4984, 1.8288, 0.06], el_dims=[3.6576, 0.04, 0.1016], conv_current_location=conv_Bot_Stud)
# Complementary nailing for any remaining vertical elements
