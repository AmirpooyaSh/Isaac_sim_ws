...
# Pass Top Plate to Robot 1
Pass_Long_Element_G2G(el_name='Top_Stud', L=3.6576, H=0.1016)
# Place Top Plate on Smart Conveyor
...
# Place L/U Stud by Robot1 Suction
...
Nail_and_Release_Vertical_Element(el_name='R_Stud_10', X=1.2592, L=2.4384, H=0.1016, Side_Selector=side_selector_R10, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name='R_Stud_12', X=1.2592, L=2.4384, H=0.1016, Side_Selector=side_selector_R12, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name='R_Stud_14', X=1.2592, L=2.4384, H=0.1016, Side_Selector=side_selector_R14, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name='R_Stud_16', X=1.2592, L=2.4384, H=0.1016, Side_Selector=side_selector_R16, Is_Held=False)
...
# Place Bottom Plate with Robot2 Gripper
conv_loc_bottom = Place_Short_Horizontal_Element_On_Smart_Conveyor_by_Rob2_Gripper(el_name='Bot_Stud', X=2.4984, Y=1.8288, L=3.6576, H=0.1016)
# Nail Bottom Plate using Robot2 NailGun
Nail_Short_Horizontal_Element_by_Rob2_NailGun(el_pose=[2.4984, 1.8288, 0.06], el_dims=[3.6576, 0.04, 0.1016], conv_current_location=conv_loc_bottom)
