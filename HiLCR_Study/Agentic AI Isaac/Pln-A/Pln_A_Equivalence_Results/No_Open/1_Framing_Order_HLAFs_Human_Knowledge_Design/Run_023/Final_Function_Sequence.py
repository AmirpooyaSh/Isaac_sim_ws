...
# Install first Vertical Stud (F_Stud): Pick, Place, Nail
...
# Install L/U Stud immediately after first stud: Pick, Pass, Place
...
# Install Vertical Stud R_Stud_2: Pick, Place, Nail
...
Nail_and_Release_Vertical_Element(el_name='R_Stud_10', X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_R10, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name='R_Stud_12', X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_R12, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name='R_Stud_14', X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_R14, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name='R_Stud_16', X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_R16, Is_Held=False)
...
# Nail all stored vertical-to-plate connections
