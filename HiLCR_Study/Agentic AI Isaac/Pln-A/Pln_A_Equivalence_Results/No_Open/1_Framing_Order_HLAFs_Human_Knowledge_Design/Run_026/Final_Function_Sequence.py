...
# Install Top Plate (Pick -> Pass -> Place -> Nail)
...
conv_Top_Stud_loc = Place_Short_Horizontal_Element_On_Smart_Conveyor_by_Rob1_Gripper(el_name="Top_Stud", X=0.02, Y=1.8288, L=3.6576, H=0.1016)
Nail_Short_Horizontal_Element_by_Rob1_NailGun(el_pose=[0.02, 1.8288, 0.06], el_dims=[3.6576, 0.04, 0.1016], conv_current_location=conv_Top_Stud_loc)
# Install first standard vertical stud F_Stud (Pick -> Place -> Nail)
...
# Install optional L/U stud L_U_Element_1 (Pick -> Pass -> Place)
...
side_sel_R_Stud_10 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.2592, Y=1.544, L=2.4384, H=0.1016)
Nail_and_Release_Vertical_Element(el_name="R_Stud_10", X=1.2592, L=2.4384, H=0.1016, Side_Selector=side_sel_R_Stud_10, Is_Held=False)
# Install vertical stud R_Stud_12
Pick_8ft_Element_From_Sloped_Table(el_name="R_Stud_12", L=2.4384, W=0.04, H=0.1016)
side_sel_R_Stud_12 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.2592, Y=1.8488, L=2.4384, H=0.1016)
Nail_and_Release_Vertical_Element(el_name="R_Stud_12", X=1.2592, L=2.4384, H=0.1016, Side_Selector=side_sel_R_Stud_12, Is_Held=False)
# Install vertical stud R_Stud_14
Pick_8ft_Element_From_Sloped_Table(el_name="R_Stud_14", L=2.4384, W=0.04, H=0.1016)
side_sel_R_Stud_14 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.2592, Y=2.1536, L=2.4384, H=0.1016)
Nail_and_Release_Vertical_Element(el_name="R_Stud_14", X=1.2592, L=2.4384, H=0.1016, Side_Selector=side_sel_R_Stud_14, Is_Held=False)
# Install vertical stud R_Stud_16
Pick_8ft_Element_From_Sloped_Table(el_name="R_Stud_16", L=2.4384, W=0.04, H=0.1016)
side_sel_R_Stud_16 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.2592, Y=2.4584, L=2.4384, H=0.1016)
Nail_and_Release_Vertical_Element(el_name="R_Stud_16", X=1.2592, L=2.4384, H=0.1016, Side_Selector=side_sel_R_Stud_16, Is_Held=False)
...
conv_Bot_Stud_loc = Place_Short_Horizontal_Element_On_Smart_Conveyor_by_Rob2_Gripper(el_name="Bot_Stud", X=2.4984, Y=1.8288, L=3.6576, H=0.1016)
Nail_Short_Horizontal_Element_by_Rob2_NailGun(el_pose=[2.4984, 1.8288, 0.06], el_dims=[3.6576, 0.04, 0.1016], conv_current_location=conv_Bot_Stud_loc)
