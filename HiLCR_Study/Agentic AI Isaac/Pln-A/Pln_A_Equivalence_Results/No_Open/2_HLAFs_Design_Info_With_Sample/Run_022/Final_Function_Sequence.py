...
# Pick, hold, nail, and release the first full-height stud
...
# Pick, pass, and suction-place the L/U stud
...
# Pick, hold, nail, and release repetitive full-height studs
...
# Perform complementary nailing across all logged vertical elements
