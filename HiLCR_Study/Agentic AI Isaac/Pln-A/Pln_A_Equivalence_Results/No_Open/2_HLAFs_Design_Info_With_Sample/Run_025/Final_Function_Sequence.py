...
LU_Element_SS = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.2592, Y=0.0908, L=2.4384, H=0.1016)
Nail_and_Release_Vertical_Element(el_name="L_U_Element_1", X=1.2592, L=2.4384, H=0.1016, Side_Selector=LU_Element_SS)
# Repetitive Vertical Stud 2
