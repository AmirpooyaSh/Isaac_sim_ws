...
# Pick, place, nail and release the first vertical stud (F_Stud)
...
# Repetitive vertical studs: pick, place, nail, and release each
...
# Complementary nailing along the bottom plate
