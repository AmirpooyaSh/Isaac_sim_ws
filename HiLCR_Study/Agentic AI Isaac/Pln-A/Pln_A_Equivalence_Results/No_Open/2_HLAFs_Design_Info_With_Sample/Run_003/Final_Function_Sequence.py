...
# Pick, place, nail and release the first vertical stud (front stud)
...
# Place the L/U stud with suction hand-off (no immediate nailing)
...
# Perform complementary nailing on all stored nail locations
