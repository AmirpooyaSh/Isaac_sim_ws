...
# L_U_Element_1 – 8-ft stud via suction hand-off
...
# LJ_1 – left jack stud (tangent left)
...
# RJ_1 – right jack stud (tangent right)
...
# TSP_1 – top sill plate (short horizontal)
...
# LJ_2 – left jack stud (tangent left)
...
# RJ_2 – right jack stud (tangent right)
