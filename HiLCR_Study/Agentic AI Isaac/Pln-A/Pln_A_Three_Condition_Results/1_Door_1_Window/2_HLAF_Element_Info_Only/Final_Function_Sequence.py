...
# Start assembly plan for 1_Door_1_Window wall panel
# ---- Top Plate ----
...
Nail_Short_Horizontal_Element_by_Rob1_NailGun(push_to_nail=0.01, el_pose=[0.4584, 1.2, 0.0], el_dims=[0.92, 0.04, 0.1016], conv_current_location=conv_loc_TSP)
# ---- Short Horizontal Element BS_1 (Lower Sill Plate) ----
Pick_Short_Element_From_Mat_Supply(el_name="BS_1", L=0.78, W=0.04, H=0.1016)
Pass_Short_Element_G2G(el_name="BS_1", H=0.1016)
conv_loc_BS = Place_Short_Horizontal_Element_On_Smart_Conveyor_by_Rob1_Gripper(el_name="BS_1", X=1.8984, Y=2.6876, L=0.78, H=0.1016)
Nail_Short_Horizontal_Element_by_Rob1_NailGun(push_to_nail=0.01, el_pose=[1.8984, 2.6876, 0.0], el_dims=[0.78, 0.04, 0.1016], conv_current_location=conv_loc_BS)
# ---- 2x10 Header BL_1 ----
Pick_2x10_Header(X=0.5514, L=0.86)
Cut_2x10_Header(L=0.86, W=0.0508, H=0.254)
conv_loc_BL_1 = Place_2x10_Header(X=0.5514, Y=2.6876, Z=0.0254, L=0.86, W=0.0508, H=0.254)
Nail_2x10_Header(push_to_nail=0.025, el_pose=[0.5514, 2.6876, 0.0254], el_dims=[0.86, 0.0508, 0.254], conv_current_location=conv_loc_BL_1)
# ---- 2x10 Header BL_2 ----
Pick_2x10_Header(X=0.5514, L=0.86)
Cut_2x10_Header(L=0.86, W=0.0508, H=0.254)
conv_loc_BL_2 = Place_2x10_Header(X=0.5514, Y=2.6876, Z=0.0762, L=0.86, W=0.0508, H=0.254)
Nail_2x10_Header(push_to_nail=0.025, el_pose=[0.5514, 2.6876, 0.0762], el_dims=[0.86, 0.0508, 0.254], conv_current_location=conv_loc_BL_2)
# ---- Complementary Nail Operation for all logged poses ----
