...
# Pick and place Top_Stud (Top Plate)
...
# Pick and place Bot_Stud (Bottom Plate)
...
# Pick, hold, nail, and release F_Stud
...
# Pick, hold, nail, and release L_U_Element_1
...
Nail_and_Release_Vertical_Element(el_name='L_U_Element_1', X=1.2592, L=2.4384, H=0.1016, Side_Selector=side_L_U_Element_1, Is_Held=False)
# Pick, hold, nail, and release R_Stud_2
...
# Pick, hold, nail, and release R_Stud_4
...
# Pick, hold, nail, and release R_Stud_6
...
# Pick, hold, nail, and release R_Stud_8
...
# Pick, hold, nail, and release R_Stud_10
Pick_8ft_Element_From_Sloped_Table(el_name='R_Stud_10', L=2.4384, W=0.04, H=0.1016)
side_R_Stud_10 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.2592, Y=1.544, L=2.4384, H=0.1016)
Nail_and_Release_Vertical_Element(el_name='R_Stud_10', X=1.2592, L=2.4384, H=0.1016, Side_Selector=side_R_Stud_10, Is_Held=False)
# Pick, hold, nail, and release R_Stud_12
Pick_8ft_Element_From_Sloped_Table(el_name='R_Stud_12', L=2.4384, W=0.04, H=0.1016)
side_R_Stud_12 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.2592, Y=1.8488, L=2.4384, H=0.1016)
Nail_and_Release_Vertical_Element(el_name='R_Stud_12', X=1.2592, L=2.4384, H=0.1016, Side_Selector=side_R_Stud_12, Is_Held=False)
# Pick, hold, nail, and release R_Stud_14
Pick_8ft_Element_From_Sloped_Table(el_name='R_Stud_14', L=2.4384, W=0.04, H=0.1016)
side_R_Stud_14 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.2592, Y=2.1536, L=2.4384, H=0.1016)
Nail_and_Release_Vertical_Element(el_name='R_Stud_14', X=1.2592, L=2.4384, H=0.1016, Side_Selector=side_R_Stud_14, Is_Held=False)
# Pick, hold, nail, and release R_Stud_16
Pick_8ft_Element_From_Sloped_Table(el_name='R_Stud_16', L=2.4384, W=0.04, H=0.1016)
side_R_Stud_16 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(X=1.2592, Y=2.4584, L=2.4384, H=0.1016)
Nail_and_Release_Vertical_Element(el_name='R_Stud_16', X=1.2592, L=2.4384, H=0.1016, Side_Selector=side_R_Stud_16, Is_Held=False)
# Pick, hold, nail, and release R_Stud_18
...
# Pick, hold, nail, and release R_Stud_20
...
# Pick, hold, nail, and release R_Stud_22
...
# Pick, hold, nail, and release R_Stud_24
