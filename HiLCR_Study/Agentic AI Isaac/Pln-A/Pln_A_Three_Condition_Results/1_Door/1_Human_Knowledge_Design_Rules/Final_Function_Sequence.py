...
Nail_and_Release_Vertical_Element(el_name='Wooden_Element_6', X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_King_Left, Is_Held=False)
...
Nail_and_Release_Vertical_Element(el_name='Wooden_Element_7', X=1.2592, push_to_nail=0.05, L=2.4384, H=0.1016, Side_Selector=side_King_Right, Is_Held=False)
...
Nail_Vertical_Element_With_Tangent_to_an_Element(push_to_nail=0.01, el_pose=[1.4784, 1.56, 0.0], el_dims=[2.0, 0.04, 0.1016], If_Tangent_From_Left=True, Side_Selector=side_Jack_Left)
...
Nail_Vertical_Element_With_Tangent_to_an_Element(push_to_nail=0.01, el_pose=[1.4784, 2.48, 0.0], el_dims=[2.0, 0.04, 0.1016], If_Tangent_From_Left=False, Side_Selector=side_Jack_Right)
...
Nail_Short_Horizontal_Element_by_Rob1_NailGun(push_to_nail=0.01, el_pose=[0.3514, 2.02, 0.0254], el_dims=[0.96, 0.0508, 0.254], conv_current_location=conv_loc_header1)
...
Nail_Short_Horizontal_Element_by_Rob1_NailGun(push_to_nail=0.01, el_pose=[0.3514, 2.02, 0.0762], el_dims=[0.96, 0.0508, 0.254], conv_current_location=conv_loc_header2)
...
Nail_2x10_Header(push_to_nail=0.025, el_pose=[2.4984, 1.8288, 0.06], el_dims=[3.6576, 0.04, 0.1016], conv_current_location=2.275)
