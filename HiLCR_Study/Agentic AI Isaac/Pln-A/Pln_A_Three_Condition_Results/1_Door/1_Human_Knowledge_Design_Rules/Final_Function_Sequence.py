...
# Install Standard Vertical Stud (R_Stud_2): Pick -> Place -> Nail
...
# Install Standard Vertical Stud (R_Stud_4): Pick -> Place -> Nail
...
# Install Standard Vertical Stud (R_Stud_6): Pick -> Place -> Nail
...
# Install Standard Vertical Stud (R_Stud_8): Pick -> Place -> Nail
...
# Install Door Left King Stud (Wooden_Element_6): Pick -> Place -> Nail
...
# Install Door Left Jack Stud (Wooden_Element_12): Pick -> Place -> Nail
...
Nail_and_Release_Vertical_Element(el_name="Wooden_Element_12", X=1.4784, L=2.0, H=0.1016, Side_Selector=1, Is_Held=False)
# Install Door Header Plank 1 (Wooden_Element_13): Pick -> Place -> Nail
...
# Install Door Header Plank 2 (Wooden_Element_14): Pick -> Place -> Nail
Pick_2x10_Header(X=0.3514, L=0.96)
...
# Install Door Right Jack Stud (Wooden_Element_11): Pick -> Place -> Nail
...
Nail_and_Release_Vertical_Element(el_name="Wooden_Element_11", X=1.4784, L=2.0, H=0.1016, Side_Selector=1, Is_Held=False)
# Install Door Right King Stud (Wooden_Element_7): Pick -> Place -> Nail
...
# Continue with Standard Vertical Studs after Door Opening (R_Stud_18): Pick -> Place -> Nail
...
# Install Standard Vertical Stud (R_Stud_20): Pick -> Place -> Nail
...
# Install Standard Vertical Stud (R_Stud_22): Pick -> Place -> Nail
...
# Install Standard Vertical Stud (R_Stud_24): Pick -> Place -> Nail
...
# Install Bottom Plate (Bot_Stud): Pick -> Pass -> Place
...
# Perform complementary nailing operations for all recorded nail poses
