...
side_L_U_Element_1 = Place_and_Hold_8ft_Element_On_Smart_Conveyor(
    X=1.2592,
    Y=0.0908,
    L=2.4384,
    H=0.1016
...
Nail_and_Release_Vertical_Element(
    ...
    L=2.4384,
    H=2.4384,
    Side_Selector=side_L_U_Element_1,
    Is_Held=False
)
...
# --- Complementary Nailing of All Logged Vertical Elements ------------------
