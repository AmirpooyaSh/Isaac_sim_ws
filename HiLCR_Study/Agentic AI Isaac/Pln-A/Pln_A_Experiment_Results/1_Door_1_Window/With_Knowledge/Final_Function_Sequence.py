...
# 2. Install first standard stud (F_Stud)
...
# 3. Install optional L/U Stud (L_U_Element_1)
...
# 4. Install next standard stud (R_Stud_1)
...
# 5. Door Opening – Left King Stud (LK_1)
...
# 6. Door Opening – Right King Stud (RK_1)
...
# 7. Door Opening – Left Jack Stud (LJ_1)
...
# 8. Door Opening – Right Jack Stud (RJ_1)
...
# 9. Door Opening – Top Sill Plate (TSP_1)
...
# 10. Door Opening – Top Cripple Studs (TCP_2, TCP_1, TCP_3) left-to-right
...
# 11. Install intermediate standard stud (R_Stud_2)
...
# 12. Window Opening – Left King Stud (RK_2 acts as leftmost by Y)
...
# 13. Window Opening – Right King Stud (LK_2)
...
# 14. Window Opening – Left Jack Stud (RJ_2)
...
# 15. Window Opening – Right Jack Stud (LJ_2)
...
# 16. Window Opening – Bear Loading Plank 1 (BL_1)
Pick_Short_Element_From_Mat_Supply(el_name="BL_1", L=0.86, W=0.0508, H=0.254)
Pass_Short_Element_G2G(el_name="BL_1", H=0.254)
conv_BL_1 = Place_Short_Horizontal_Element_On_Smart_Conveyor_by_Rob1_Gripper(el_name="BL_1", X=0.5514, Y=2.6876, L=0.86, H=0.254)

# 17. Window Opening – Bear Loading Plank 2 (BL_2)
Pick_Short_Element_From_Mat_Supply(el_name="BL_2", L=0.86, W=0.0508, H=0.254)
Pass_Short_Element_G2G(el_name="BL_2", H=0.254)
conv_BL_2 = Place_Short_Horizontal_Element_On_Smart_Conveyor_by_Rob1_Gripper(el_name="BL_2", X=0.5514, Y=2.6876, L=0.86, H=0.254)

# 18. Window Opening – Lower Sill Plate (BS_1)
Pick_Short_Element_From_Mat_Supply(el_name="BS_1", L=0.78, W=0.04, H=0.1016)
Pass_Short_Element_G2G(el_name="BS_1", H=0.1016)
conv_BS_1 = Place_Short_Horizontal_Element_On_Smart_Conveyor_by_Rob1_Gripper(el_name="BS_1", X=1.8984, Y=2.6876, L=0.78, H=0.1016)

# 19. Window Opening – Lower Cripple Stud (LC_1)
...
# 20. Window Opening – Lower Cripple Stud (LC_2)
...
# 21. Install final standard stud (R_Stud_3)
